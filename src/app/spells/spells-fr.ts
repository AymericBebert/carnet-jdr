...
export const spellsFr: Spell[] = [
  ...
  },
  {
    ...
    source: 'Player’s Handbook (SRD)',
    classes: ['Ensorceleur', 'Magicien'],
    details: '<div class="ecole">niveau 1 - abjuration</div><div class="t"><strong>Temps d’incantation</strong> : 1 réaction, que vous prenez lorsque vous êtes touché par une attaque ou ciblé par le sort <em><a href="https://www.aidedd.org/dnd/sorts.php?vf=projectile-magique">projectile magique</a></em></div><div class="r"><strong>Portée</strong> : personnelle</div><div class="c"><strong>Composantes</strong> : V, S</div><div class="d"><strong>Durée</strong> : 1 round</div><div class="description">Une barrière invisible de force magique apparaît et vous protège. Jusqu’au début de votre prochain tour, vous obtenez un bonus de +5 à votre CA, y compris contre l’attaque qui a déclenché le sort, et vous ne prenez aucun dégât par le sort <em><a href="https://www.aidedd.org/dnd/sorts.php?vf=projectile-magique">projectile magique</a></em>.</div>',
  },
  {
    id: 'bouclier-de-feu',
